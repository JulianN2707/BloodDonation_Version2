...
using Usuarios;
using Usuarios.Application.Consumers;
...
var configuration = builder.Configuration
    ...
    .Build();
var appName = configuration.GetValue<string>("AppName") ?? "Usuarios";
...
if (providerMQ.Equals("activeMQ"))
{
    ...
    builder.Services.AddMassTransit(x =>
    {
        ...
        x.UsingActiveMq((context, cfg) =>
        {
            ...
            cfg.ReceiveEndpoint($"crear-usuario", x =>
            {
                x.ConfigureConsumeTopology = false;
                x.ConfigureConsumer<CrearUsuarioConsumer>(context, cfg =>
                {
...
{
    setupAction.DocumentTitle = "Usuarios API";
